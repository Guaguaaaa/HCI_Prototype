...
LOCALIZATION_STRINGS = {
    ...
    "consent": {
        ...
        "zh-CN": {
            "title": "研究实验：知情同意书确认",
            "title_h3": "研究摘要与流程",
            "pdf_important": "重要提示：在继续之前，请确保您已阅读并签署实验人员提供的完整<strong>知情同意书 (ICF) PDF</strong>。",
            "procedure_summary": "您正在确认参与一项关于<strong>AI 可解释性及其对用户感知影响</strong>的研究。预计总实验时间为 <strong>15–20 分钟</strong>。",
            "procedure_steps": "核心步骤包括：<strong>问卷调查 → 与 AI Agent 的简短对话 → 实验后问卷。</strong>",
            "rights_title": "关键权利摘要",
            "voluntary_withdrawal": "自愿参与和退出：您自愿参与（<strong>Voluntary Participation</strong>），可随时退出实验，不会受到任何惩罚。如果您退出，已收集的数据将被删除。",
            "anonymity": "匿名性：您的所有对话指标和问卷回答都将匿名化，仅用于学术研究。",
            "disclaimer": "重要免责声明：AI Agent <strong>不是专业人士</strong>。它不提供医疗或心理支持。如果您感到不适，请立即停止并联系实验人员：<strong>hi@peterguan.com</strong>。",
    ...
    "baseline_mood": {
        ...
        "zh-CN": {
            ...
            "q1_valence": "1. 我现在的情绪总体上是积极的。*",
            "q1_negative": "1 (非常消极)",
            "q1_positive": "7 (非常积极)",
            "q2_arousal": "2. 我现在感到精力充沛或紧张。*",
            "q2_calm": "1 (非常平静/低能量)",
    ...
    "instructions": {
        ...
        "zh-CN": {
            "title_xai": "实验任务说明",
            "title_non_xai": "实验任务说明",
            "task_overview": "任务概览",
            "task_text": "您即将开始实验的主要部分：与一个<strong>AI 情感支持 Agent（Agent）</strong>进行对话。在此任务中，您将以一个富有同理心、非专业倾听者的身份与 Agent 互动。",
            "role_goal": "您的角色与对话目标",
            "role_text": "请以自然的方式与 Agent 交流，就像与一位亲密、支持您的朋友分享想法一样。<strong>您的角色就是您自己。</strong>",
            "list_goal": "目标：讨论任何与您的感受、日常生活、近期挑战或小成就相关的话题。Agent 的目的是提供<strong>情感支持和理解 (Emotional Support and Understanding)</strong>。",
            "list_avoid": "应避免事项：请避免向 Agent 寻求专业建议（例如，编程、法律、医疗或复杂的财务分析）。",
            "list_duration": "时长：对话应持续约 <strong>10 到 15 个回合</strong>（消息往复）。没有严格的时间限制，但请努力进行一次有意义的互动。",
            "xai_interface_title": "界面说明（重要）",
            "xai_interface_box": "您会注意到聊天界面有一个<strong>专用的右侧面板</strong>。该面板显示了关于 AI 内部状态或决策的<strong>解释（XAI）</strong>。",
            "xai_interface_list1": "XAI 解释旨在提供洞察，说明 Agent <em>为什么</em>以某种方式回应或 <em>如何</em>感知您的消息。",
            ...
            "ending_title": "结束对话",
            "ending_text1": "当您认为自己已充分表达了感受并准备结束任务时，请点击专用的<strong>结束对话</strong>按钮。",
            "ending_list1": "点击按钮后将出现一个确认对话框，以确保您已准备好继续。",
            "ending_list2": "一旦确认，系统将保存最终的对话指标并自动将您带到实验后问卷。",
            "support_title": "实验支持与退出",
            "support_text1": "请记住，您的参与是<strong>自愿的 (Voluntary)</strong>。您可以随时退出实验，不会受到任何惩罚或损失任何福利。如果您希望退出，只需通知实验人员即可。",
    ...
    "post_questionnaire": {
        ...
        "zh-CN": {
            ...
            "section_a_title": "A 部分：<strong>信任 (Trust)</strong>（总体可靠性和意图）",
            "q1_reliable": "1. 该 Agent 是可靠的。*",
            "q2_predictable": "2. 该 Agent 的行为是可预测的。*",
            "q3_dependent": "3. 在寻求情感支持时，我会依赖这个 Agent。*",
            "q4_confidence": "4. 我相信该 Agent 可以正确识别 我的情绪。*",
            "q5_intent": "5. 我认为该 Agent 的目标是帮助我（而不是误导）。*",
            "q6_skeptic": "6. 我对该 Agent 的判断持怀疑态度。*",

            "section_b_title": "B 部分：<strong>感知到的共情 (Perceived Empathy)</strong>",
            "q7_understood": "7. 该 Agent 似乎理解我的感受。*",
            "q8_cared": "8. 该 Agent 的回应让我感到被关心。*",
            "q9_responsive": "9. 该 Agent 的回复与我的情绪状态相关。*",
            "q10_warm": "10. 该 Agent 传达了温暖或关切。*",
            "q11_respect": "11. 我觉得该 Agent 尊重了我的情绪和观点。*",
            "q12_insincere": "12. 该 Agent 的共情显得不真诚。*",
            ...
            "section_d_title": "D 部分：解释反馈 (<strong>XAI</strong>) ",
            "q15_useful": "15. Agent 提供的解释是有用的。*",
            "q16_clear": "16. 该解释是清晰且易于理解的。*",
    ...
    "debrief": {
        ...
        "zh-CN": {
            ...
            "contact_p1": "问题或疑虑：",
            "contact_p2": "<strong>获取结果：</strong>如果您希望在研究完成后获得一份研究结果摘要，请发送邮件给研究人员，主题为：“Request Research Results”；或告知研究人员",
